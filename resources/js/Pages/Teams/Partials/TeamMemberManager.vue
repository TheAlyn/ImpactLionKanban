    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                <template #title>
                    <span class="text-gray-100">Adicionar membro da equipe</span>
                </template>

                <template #description>
                    Adicione um novo membro à sua equipe, permitindo que ele colabore com você.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Forneça o endereço de e-mail da pessoa que você gostaria de adicionar a esta equipe.
                        </div>
                    </div>
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        <InputLabel for="roles" value="Permissão" class="text-gray-200" />
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                <template #title>
                    <span class="text-gray-100">Convites de equipe pendentes</span>
                </template>

                <template #description>
                    Essa pessoa foi convidada para entrar em sua equipe e recebeu um e-mail de convite. 
                    Ela pode se juntar à equipe aceitando o convite por e-mail.
                </template>
